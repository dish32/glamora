...
<div class="container">
  ...
  <?php 
      ...
      mysqli_select_db($con, "glamorasalon_db");
      ...
      while ($row = mysqli_fetch_array($result)) {
          ...
          $price = $row[3];
          $image = $row[4];
          $imageUrl = "photos/" . $image;

          echo "
              <div class='item' onclick=\"openModal('$pid', '$imageUrl', '$name', '$description', '$price')\">
...
<div id="itemModal" class="modal" onclick="closeModal(event)">
  <form method="POST" action="add_to_cart.php">
    <div class="modal-content" onclick="event.stopPropagation();">
      ...
      <h3 id="modalPriceDisplay"></h3>

      <input type="hidden" id="hiddenId" name="id">
      <input type="hidden" id="hiddenName" name="name">
      <input type="hidden" id="hiddenPrice" name="price">

      <input type="number" id="quantity" class="quantity" name="qty" value="1" min="1" />
...
<script>
  function openModal(id, imageSrc, name, description, price) {
    document.getElementById('modalImage').src = imageSrc;
    document.getElementById('modalName').innerText = name;
    document.getElementById('modalDescription').innerText = description;
    document.getElementById('modalPriceDisplay').innerText = "LKR " + price;
